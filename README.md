...
actor and film actor don't look like they directly connect, the primary key on actor is actor_id and the primary key on film_actor looks to be a combination of actor_id and film_id so I'd say the relationship is one to many since one actor could be involved in alot of films.
...
3 by clicking on the indexes tab and looking for FK
##### ER Diagram upload
